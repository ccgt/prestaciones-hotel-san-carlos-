...
{
    public partial class formularioAguinaldo : Form
    {
        public formularioAguinaldo()
        {
            InitializeComponent();
        }
        ...
        string anioComparacion;
            ...
            conexion_baseDatos.conectar();
                string Query = "insert into aguinaldo(idAguinaldo,fecha_aguinaldo_pago,valorPercepcion,estadoPago,contrato_idContrato) values(null,'" + date + "',@pago,0,@idcon);";
              ...
              conexion_baseDatos.OpenConnection();
                ...
                MessageBox.Show("Aguinaldo ha sido calculado");

                conexion_baseDatos.CloseConnection();

            }
        void calculoMenor1DiciembrePresente()
        {
            string date = actual.ToString("yyyy-MM-dd");
            conexion_baseDatos.conectar();
            string Query = "insert into aguinaldo(idAguinaldo,fecha_aguinaldo_pago,valorPercepcion,estadoPago,contrato_idContrato) values(null,'" + date + "',@percepcion,1,@idcon);";
            MySqlCommand command = new MySqlCommand(Query, conexion_baseDatos.conexion);
            conexion_baseDatos.OpenConnection();
          ...
          //  MessageBox.Show("aguinaldo nuevos creado");

            conexion_baseDatos.CloseConnection();

        }

        void calculoMayor1DiciembrePresente()
        {
            string date = actual.ToString("yyyy-MM-dd");
            conexion_baseDatos.conectar();
            string Query = "insert into aguinaldo(idAguinaldo,fecha_aguinaldo_pago,valorPercepcion,estadoPago,contrato_idContrato) values(null,'" + date + "',@pago,0,@idcon);";
        ...
        void calculoAcumulativo()
        {
            string date = actual.ToString("yyyy-MM-dd ");
            conexion_baseDatos.conectar();
            string Query = "UPDATE aguinaldo SET fecha_aguinaldo_pago ='" + date + "', valorPercepcion = @monto where contrato_idContrato=@idcontratoBono";
            MySqlCommand command = new MySqlCommand(Query, conexion_baseDatos.conexion);
            conexion_baseDatos.OpenConnection();
        ...
        //    MessageBox.Show("aguinaldo actualizado");
        ...
        void modificarDespues1Diciembre()
        {
            string date = actual.ToString("yyyy-MM-dd H:mm:ss");
            conexion_baseDatos.conectar();
            string Query = "UPDATE aguinaldo SET fecha_aguinaldo_pago ='" + date + "', valorPercepcion = @monto where contrato_idContrato=@idcontratoBono";
        ...
        private void formularioAguinaldo_Load(object sender, EventArgs e)
        {
        ...
        {
            string parametro;
            parametro = busAguinaldo.Text;
            conexion_baseDatos.conectar();
            dataGridView1.DataSource =conexion_baseDatos.llenarDataGridView("select empleado.primerNombre, empleado.segundoNombre, empleado.apellidoPaterno, empleado.apellidoMaterno, contrato.inicioRelacionTrabajo, contrato.sueldoBase, aguinaldo.fecha_aguinaldo_pago, aguinaldo.valorPercepcion, aguinaldo.estadoPago from empleado, contrato, aguinaldo where contrato.empleado_idEmpleado = '" + parametro + "' and empleado.idEmpleado = '" + parametro + "' and aguinaldo.contrato_idContrato = contrato.idContrato");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "select idContrato,inicioRelacionTrabajo,sueldoBase from contrato where inicioRelacionTrabajo >= '" + anioActual + "-01-01' and inicioRelacionTrabajo <= '" + anioActual + "-11-30'   and idContrato NOT IN(SELECT contrato_idContrato FROM aguinaldo)";
               ...
               conexion_baseDatos.OpenConnection();
                ...
                calculoMenor1DiciembrePresente();
            }
            catch (Exception ex)
            {
            ...
            //            }
            /*********************** si el trabajador ingreso despues del 30 de noviembre a trabajar ***********************************/

            try
            {

                conexion_baseDatos.conectar();
                string Query = "select idContrato, inicioRelacionTrabajo, sueldoBase from contrato where inicioRelacionTrabajo >= '" + anioActual + "-12-01' and inicioRelacionTrabajo <= '" + anioActual + "-12-31' and idContrato NOT IN(SELECT contrato_idContrato FROM aguinaldo)";
                MySqlCommand MyCommand2 = new MySqlCommand(Query, conexion_baseDatos.conexion);
                MySqlDataReader MyReader2;
                conexion_baseDatos.OpenConnection();
                MyReader2 = MyCommand2.ExecuteReader();
                ...
                calculoMayor1DiciembrePresente();
            ...
            //anio menor a  actual antes de 1 de dic F
            ...
            //MODIFICAR SI EMPLEADO EXISTE YA EN aguinaldo" ****************************************************
            ...
            try
            {
                ...
                string Query = "select contrato.inicioRelacionTrabajo,aguinaldo.fecha_aguinaldo_pago,contrato.sueldoBase,aguinaldo.contrato_idContrato from contrato,aguinaldo where  contrato.idContrato = aguinaldo.contrato_idContrato and aguinaldo.fecha_aguinaldo_pago >= '" + anioActual + "-01-01' and aguinaldo.fecha_aguinaldo_pago <= '" + anioActual + "-11-30'";
               ...
               conexion_baseDatos.OpenConnection();
                ...
                foreach (string fecha in listaFechasC)
                {
                    ...
                    // diferencia en dias.
                    int diasDiferencia = td.Days;
                  //  textBox5.Text += diasDiferencia.ToString();
                    int anio = 365;
 ...
 // si empleado modificamos despues de 1 dic
            ...
            try
            {
                ...
                conexion_baseDatos.conectar();
                // "select bono14.fechaBono14,contrato.sueldoBase,bono14.contrato_idContrato from contrato,bono14 where  contrato.idContrato = bono14.contrato_idContrato and bono14.fechaBono14 >= '" + anioActual + "-01-01' and bono14.fechaBono14 <= '" + anioActual + "-12-31'";
                string Query = "select contrato.inicioRelacionTrabajo,aguinaldo.fecha_aguinaldo_pago,contrato.sueldoBase,aguinaldo.contrato_idContrato from contrato,aguinaldo where  contrato.idContrato = aguinaldo.contrato_idContrato and aguinaldo.fecha_aguinaldo_pago >= '" + anioActual + "-12-01' and aguinaldo.fecha_aguinaldo_pago <= '" + anioActual + "-12-31'";
            ...
            try
            {
                ...
                conexion_baseDatos.conectar();
                string Query = "select contrato.inicioRelacionTrabajo,aguinaldo.fecha_aguinaldo_pago,contrato.sueldoBase,aguinaldo.contrato_idContrato from contrato,aguinaldo where aguinaldo.fecha_aguinaldo_pago >= '" + anioMenos_ + "-12-01' and aguinaldo.fecha_aguinaldo_pago <= '" + anioActual + "-11-30' and contrato.idContrato = aguinaldo.contrato_idContrato";
                MySqlCommand MyCommand2 = new MySqlCommand(Query, conexion_baseDatos.conexion);
                MySqlDataReader MyReader2;
                conexion_baseDatos.OpenConnection();
                MyReader2 = MyCommand2.ExecuteReader();
            ...
            try
            {
                //textBox11.Text = "quepuata";

                conexion_baseDatos.conectar();
                string Query = "select idContrato,inicioRelacionTrabajo,sueldoBase from contrato where inicioRelacionTrabajo <= '" + anioMenos_ + "-11-30'   and idContrato NOT IN(SELECT contrato_idContrato FROM aguinaldo)";
                MySqlCommand MyCommand2 = new MySqlCommand(Query, conexion_baseDatos.conexion);
                MySqlDataReader MyReader2;
                conexion_baseDatos.OpenConnection();
                MyReader2 = MyCommand2.ExecuteReader();
               ...
               conexion_baseDatos.CloseConnection();
                ...
                foreach (string fecha in listaFechasF)
                {
                    ...
                    DateTime fechaCorte2 = new DateTime(int.Parse(anioActual), 11, 30);
